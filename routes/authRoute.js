...
import { home, login, showlogin, showsignup, signup, showOtpPage, verifyOtp, resendOtp, updateUserType, checkUsername } from '../controller/authController.js';
...
router.get('/resend-otp', isNotLoggedIn, resendOtp);
